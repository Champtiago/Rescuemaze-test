...
namespace MotorID{
    constexpr uint8_t kBackRight=0; //3
    constexpr uint8_t kBackLeft=1;   // 2front left
    constexpr uint8_t kFrontRight=2; // 0 back left
    constexpr uint8_t kFrontLeft=3;  // 1 front right
}
...
namespace vlxID{
    ...
    constexpr uint8_t rightUp=4;
    constexpr uint8_t leftUp=2;
