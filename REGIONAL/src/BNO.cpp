...
float BNO::getOrientationY() {
    updateBNO(event_);
    return event_.orientation.z - phaseCorrectionY_;  // ahora usa Z
}
...
// Establecer corrección de fase para el eje Z (se mantiene nombre Y por compatibilidad)
...
void BNO::resetOrientation() {
    ...
    setPhaseCorrectionY(event_.orientation.z); // Reinicia el eje Z
