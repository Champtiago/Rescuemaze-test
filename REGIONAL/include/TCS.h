...
class TCS {
    private:
        ...
        static constexpr float kBlueValueInBlue_ = 50;
        //BLACK TILE
        static constexpr float kRedValueInBlack_ = 20.00;
        static constexpr float kGreenValueInBlack_ = 17.00;
        static constexpr float kBlueValueInBlack_ = 10.00;
        //CHECKPOINT TILE
        ...
        static constexpr uint8_t rgbThreshold=15;
